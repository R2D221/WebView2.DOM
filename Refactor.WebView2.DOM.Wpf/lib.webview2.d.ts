//https://github.com/jeremyong/DefinitelyTyped/blob/master/types/webview2/index.d.ts
 ...
 * required.
 */
interface HostObjectAsyncProxyBase {
...
interface WebViewMessageEvent extends Omit<MessageEvent, "source"> {
	source: WebView;
