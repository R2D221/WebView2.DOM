namespace WebView2.DOM
{
	...
	{
		public CSSVariableReferenceValue(string variable) => Construct(variable);
		public CSSVariableReferenceValue(string variable, CSSUnparsedValue fallback) => Construct(variable, fallback);
