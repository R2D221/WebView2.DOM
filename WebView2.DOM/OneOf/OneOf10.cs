...
{
	public static void Switch<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>
		(this OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>? @this
		,/**/Action<T0> f0
		,/**/Action<T1> f1
		,/**/Action<T2> f2
		,/**/Action<T3> f3
		...
		where T9 : notnull
	{
		...
		case OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> x:
			x.Switch(f0, f1, f2, f3, f4, f5, f6, f7, f8, f9);
			break;
		}
	}

	public static TResult Match<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>
		(this OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>? @this
		,/**/Func<T0, TResult> f0
		,/**/Func<T1, TResult> f1
		,/**/Func<T2, TResult> f2
		...
		where T9 : notnull
	{
		...
		{
			null => fNull(null),
			OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> x =>
				x.Match(f0, f1, f2, f3, f4, f5, f6, f7, f8, f9),
		};
	}

	public static bool Is<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>? @this, [MaybeNullWhen(false)] out T0 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>? @this, [MaybeNullWhen(false)] out T1 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>? @this, [MaybeNullWhen(false)] out T2 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>? @this, [MaybeNullWhen(false)] out T3 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>? @this, [MaybeNullWhen(false)] out T4 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>? @this, [MaybeNullWhen(false)] out T5 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>? @this, [MaybeNullWhen(false)] out T6 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>? @this, [MaybeNullWhen(false)] out T7 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>? @this, [MaybeNullWhen(false)] out T8 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>? @this, [MaybeNullWhen(false)] out T9 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
