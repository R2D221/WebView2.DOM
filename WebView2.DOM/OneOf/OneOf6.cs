...
namespace OneOf
{
	...
	public struct OneOf<T0, T1, T2, T3, T4, T5> : IEquatable<OneOf<T0, T1, T2, T3, T4, T5>>
	{
		...
		public OneOf<MapT0, T1, T2, T3, T4, T5> Map<T, MapT0>(Func<T, MapT0> mapFunc, Type<T0> _ = default!) where T : T0 => Match<OneOf<MapT0, T1, T2, T3, T4, T5>>(_0 => mapFunc((T)_0!), _1 => _1, _2 => _2, _3 => _3, _4 => _4, _5 => _5);
		public OneOf<T0, MapT1, T2, T3, T4, T5> Map<T, MapT1>(Func<T, MapT1> mapFunc, Type<T1> _ = default!) where T : T1 => Match<OneOf<T0, MapT1, T2, T3, T4, T5>>(_0 => _0, _1 => mapFunc((T)_1!), _2 => _2, _3 => _3, _4 => _4, _5 => _5);
		public OneOf<T0, T1, MapT2, T3, T4, T5> Map<T, MapT2>(Func<T, MapT2> mapFunc, Type<T2> _ = default!) where T : T2 => Match<OneOf<T0, T1, MapT2, T3, T4, T5>>(_0 => _0, _1 => _1, _2 => mapFunc((T)_2!), _3 => _3, _4 => _4, _5 => _5);
		public OneOf<T0, T1, T2, MapT3, T4, T5> Map<T, MapT3>(Func<T, MapT3> mapFunc, Type<T3> _ = default!) where T : T3 => Match<OneOf<T0, T1, T2, MapT3, T4, T5>>(_0 => _0, _1 => _1, _2 => _2, _3 => mapFunc((T)_3!), _4 => _4, _5 => _5);
		public OneOf<T0, T1, T2, T3, MapT4, T5> Map<T, MapT4>(Func<T, MapT4> mapFunc, Type<T4> _ = default!) where T : T4 => Match<OneOf<T0, T1, T2, T3, MapT4, T5>>(_0 => _0, _1 => _1, _2 => _2, _3 => _3, _4 => mapFunc((T)_4!), _5 => _5);
		public OneOf<T0, T1, T2, T3, T4, MapT5> Map<T, MapT5>(Func<T, MapT5> mapFunc, Type<T5> _ = default!) where T : T5 => Match<OneOf<T0, T1, T2, T3, T4, MapT5>>(_0 => _0, _1 => _1, _2 => _2, _3 => _3, _4 => _4, _5 => mapFunc((T)_5!));

		public bool TryPick<T>(out T value, out OneOf<T1, T2, T3, T4, T5> remainder, Type<T0> _ = default!) where T : T0 { var @is = Is<T0>(); value = @is ? (T)As<T0>()! : default!; remainder = @is ? default! : Match<OneOf<T1, T2, T3, T4, T5>>(_0 => throw new InvalidOperationException(), _1 => _1, _2 => _2, _3 => _3, _4 => _4, _5 => _5); return @is; }
		public bool TryPick<T>(out T value, out OneOf<T0, T2, T3, T4, T5> remainder, Type<T1> _ = default!) where T : T1 { var @is = Is<T1>(); value = @is ? (T)As<T1>()! : default!; remainder = @is ? default! : Match<OneOf<T0, T2, T3, T4, T5>>(_0 => _0, _1 => throw new InvalidOperationException(), _2 => _2, _3 => _3, _4 => _4, _5 => _5); return @is; }
		public bool TryPick<T>(out T value, out OneOf<T0, T1, T3, T4, T5> remainder, Type<T2> _ = default!) where T : T2 { var @is = Is<T2>(); value = @is ? (T)As<T2>()! : default!; remainder = @is ? default! : Match<OneOf<T0, T1, T3, T4, T5>>(_0 => _0, _1 => _1, _2 => throw new InvalidOperationException(), _3 => _3, _4 => _4, _5 => _5); return @is; }
		public bool TryPick<T>(out T value, out OneOf<T0, T1, T2, T4, T5> remainder, Type<T3> _ = default!) where T : T3 { var @is = Is<T3>(); value = @is ? (T)As<T3>()! : default!; remainder = @is ? default! : Match<OneOf<T0, T1, T2, T4, T5>>(_0 => _0, _1 => _1, _2 => _2, _3 => throw new InvalidOperationException(), _4 => _4, _5 => _5); return @is; }
		public bool TryPick<T>(out T value, out OneOf<T0, T1, T2, T3, T5> remainder, Type<T4> _ = default!) where T : T4 { var @is = Is<T4>(); value = @is ? (T)As<T4>()! : default!; remainder = @is ? default! : Match<OneOf<T0, T1, T2, T3, T5>>(_0 => _0, _1 => _1, _2 => _2, _3 => _3, _4 => throw new InvalidOperationException(), _5 => _5); return @is; }
		public bool TryPick<T>(out T value, out OneOf<T0, T1, T2, T3, T4> remainder, Type<T5> _ = default!) where T : T5 { var @is = Is<T5>(); value = @is ? (T)As<T5>()! : default!; remainder = @is ? default! : Match<OneOf<T0, T1, T2, T3, T4>>(_0 => _0, _1 => _1, _2 => _2, _3 => _3, _4 => _4, _5 => throw new InvalidOperationException()); return @is; }
