...
public static partial class OneOfExtensions
{
	public static void Switch<T0, T1, T2, T3, T4, T5, T6>
		(this OneOf<T0, T1, T2, T3, T4, T5, T6>? @this
		,/**/Action<T0> f0
		,/**/Action<T1> f1
		,/**/Action<T2> f2
		,/**/Action<T3> f3
		...
		where T6 : notnull
	{
		...
		case OneOf<T0, T1, T2, T3, T4, T5, T6> x:
			x.Switch(f0, f1, f2, f3, f4, f5, f6);
			break;
		}
	}
		...
		where T6 : notnull
	{
		...
		{
			null => fNull(null),
			OneOf<T0, T1, T2, T3, T4, T5, T6> x =>
				x.Match(f0, f1, f2, f3, f4, f5, f6),
		};
	}

	public static bool Is<T0, T1, T2, T3, T4, T5, T6>(this OneOf<T0, T1, T2, T3, T4, T5, T6>? @this, [MaybeNullWhen(false)] out T0 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6>(this OneOf<T0, T1, T2, T3, T4, T5, T6>? @this, [MaybeNullWhen(false)] out T1 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6>(this OneOf<T0, T1, T2, T3, T4, T5, T6>? @this, [MaybeNullWhen(false)] out T2 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6>(this OneOf<T0, T1, T2, T3, T4, T5, T6>? @this, [MaybeNullWhen(false)] out T3 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6>(this OneOf<T0, T1, T2, T3, T4, T5, T6>? @this, [MaybeNullWhen(false)] out T4 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6>(this OneOf<T0, T1, T2, T3, T4, T5, T6>? @this, [MaybeNullWhen(false)] out T5 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
	...
	public static bool Is<T0, T1, T2, T3, T4, T5, T6>(this OneOf<T0, T1, T2, T3, T4, T5, T6>? @this, [MaybeNullWhen(false)] out T6 value)
		where T0 : notnull
		where T1 : notnull
		where T2 : notnull
		where T3 : notnull
