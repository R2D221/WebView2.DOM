...
public sealed class @caption : HTMLTableCaptionElementBuilder, IEnumerable
{
	protected override HTMLTableCaptionElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.caption);
	...
	public @caption this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@caption>> actions = new();
