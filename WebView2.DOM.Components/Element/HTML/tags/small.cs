...
public sealed class @small : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.small);
	...
	public @small this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@small>> actions = new();
