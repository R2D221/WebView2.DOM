...
public sealed class @object : HTMLObjectElementBuilder, IEnumerable
{
	protected override HTMLObjectElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.@object);
	...
	public @object this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@object>> actions = new();
