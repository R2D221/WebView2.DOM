...
public sealed class @time : HTMLTimeElementBuilder, IEnumerable
{
	protected override HTMLTimeElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.time);
	...
	public @time this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@time>> actions = new();
