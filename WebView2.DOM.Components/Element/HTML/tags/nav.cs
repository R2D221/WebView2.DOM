...
public sealed class @nav : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.nav);
	...
	public @nav this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@nav>> actions = new();
