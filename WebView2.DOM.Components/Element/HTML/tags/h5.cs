...
public sealed class @h5 : HTMLHeadingElementBuilder, IEnumerable
{
	protected override HTMLHeadingElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.@h5);
	...
	public @h5 this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@h5>> actions = new();
