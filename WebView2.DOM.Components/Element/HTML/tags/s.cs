...
public sealed class @s : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.@s);
	...
	public @s this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@s>> actions = new();
