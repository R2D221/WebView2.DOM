...
public sealed class @strong : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.strong);
	...
	public @strong this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@strong>> actions = new();
