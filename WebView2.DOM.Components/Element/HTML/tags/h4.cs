...
public sealed class @h4 : HTMLHeadingElementBuilder, IEnumerable
{
	protected override HTMLHeadingElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.@h4);
	...
	public @h4 this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@h4>> actions = new();
