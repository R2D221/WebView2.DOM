...
public sealed class @i : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.i);
	...
	public @i this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@i>> actions = new();
