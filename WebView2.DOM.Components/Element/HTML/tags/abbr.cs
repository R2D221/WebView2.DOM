...
public sealed class @abbr : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.abbr);
	...
	public @abbr this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@abbr>> actions = new();
