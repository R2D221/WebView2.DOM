...
public sealed class @cite : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.cite);
	...
	public @cite this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@cite>> actions = new();
