...
public sealed class @h6 : HTMLHeadingElementBuilder, IEnumerable
{
	protected override HTMLHeadingElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.@h6);
	...
	public @h6 this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@h6>> actions = new();
