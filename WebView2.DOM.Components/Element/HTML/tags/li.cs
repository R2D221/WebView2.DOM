...
public sealed class @li : HTMLLIElementBuilder, IEnumerable
{
	protected override HTMLLIElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.li);
	...
	public @li this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@li>> actions = new();
