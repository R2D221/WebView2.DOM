...
public sealed class _var : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.var);
	...
	public _var this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<_var>> actions = new();
