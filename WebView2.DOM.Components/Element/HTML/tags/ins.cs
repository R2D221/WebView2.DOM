...
public sealed class @ins : HTMLModElementBuilder, IEnumerable
{
	protected override HTMLModElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.ins);
	...
	public @ins this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@ins>> actions = new();
