...
public sealed class @footer : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.footer);
	...
	public @footer this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@footer>> actions = new();
