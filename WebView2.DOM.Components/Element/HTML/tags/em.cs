...
public sealed class @em : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.em);
	...
	public @em this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@em>> actions = new();
