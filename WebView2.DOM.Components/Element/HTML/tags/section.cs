...
public sealed class @section : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.@section);
	...
	public @section this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@section>> actions = new();
