...
public sealed class @sup : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.sup);
	...
	public @sup this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@sup>> actions = new();
