...
public sealed class @bdi : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.bdi);
	...
	public @bdi this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@bdi>> actions = new();
