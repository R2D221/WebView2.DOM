...
public sealed class @code : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.code);
	...
	public @code this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@code>> actions = new();
