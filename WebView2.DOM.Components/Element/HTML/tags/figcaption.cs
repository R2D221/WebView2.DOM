...
public sealed class @figcaption : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.figcaption);
	...
	public @figcaption this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@figcaption>> actions = new();
