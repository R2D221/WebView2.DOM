...
public sealed class @aside : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.aside);
	...
	public @aside this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@aside>> actions = new();
