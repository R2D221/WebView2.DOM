...
public sealed class @mark : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.mark);
	...
	public @mark this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@mark>> actions = new();
