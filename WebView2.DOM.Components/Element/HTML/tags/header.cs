...
public sealed class @header : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.header);
	...
	public @header this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@header>> actions = new();
