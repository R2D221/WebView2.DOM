...
public sealed class @h1 : HTMLHeadingElementBuilder, IEnumerable
{
	protected override HTMLHeadingElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.@h1);
	...
	public @h1 this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@h1>> actions = new();
