...
public sealed class @pre : HTMLPreElementBuilder, IEnumerable
{
	protected override HTMLPreElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.pre);
	...
	public @pre this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@pre>> actions = new();
