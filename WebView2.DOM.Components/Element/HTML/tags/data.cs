...
public sealed class @data : HTMLDataElementBuilder, IEnumerable
{
	protected override HTMLDataElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.data);
	...
	public @data this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@data>> actions = new();
