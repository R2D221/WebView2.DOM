...
public sealed class @kbd : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.kbd);
	...
	public @kbd this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@kbd>> actions = new();
