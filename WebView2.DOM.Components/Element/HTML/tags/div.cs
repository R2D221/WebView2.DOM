...
public sealed class @div : HTMLDivElementBuilder, IEnumerable
{
	protected override HTMLDivElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.div);
	...
	public @div this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@div>> actions = new();
