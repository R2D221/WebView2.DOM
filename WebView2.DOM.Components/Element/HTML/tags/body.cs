...
public sealed class @body : HTMLBodyElementBuilder, IEnumerable
{
	protected override HTMLBodyElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.body);
	...
	public @body this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@body>> actions = new();
