...
public sealed class @blockquote : HTMLQuoteElementBuilder, IEnumerable
{
	protected override HTMLQuoteElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.blockquote);
	...
	public @blockquote this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@blockquote>> actions = new();
