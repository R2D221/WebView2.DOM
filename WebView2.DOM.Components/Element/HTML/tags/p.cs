...
public sealed class @p : HTMLParagraphElementBuilder, IEnumerable
{
	protected override HTMLParagraphElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.p);
	...
	public @p this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@p>> actions = new();
