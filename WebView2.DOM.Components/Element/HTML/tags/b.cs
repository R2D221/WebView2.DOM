...
public sealed class @b : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.b);
	...
	public @b this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@b>> actions = new();
