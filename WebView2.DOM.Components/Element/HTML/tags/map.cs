...
public sealed class @map : HTMLMapElementBuilder, IEnumerable
{
	protected override HTMLMapElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.map);
	...
	public @map this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@map>> actions = new();
