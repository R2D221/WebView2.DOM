...
public sealed class @sub : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.sub);
	...
	public @sub this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@sub>> actions = new();
