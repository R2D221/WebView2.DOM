...
public sealed class @h2 : HTMLHeadingElementBuilder, IEnumerable
{
	protected override HTMLHeadingElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.@h2);
	...
	public @h2 this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@h2>> actions = new();
