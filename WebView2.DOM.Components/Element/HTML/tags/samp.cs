...
public sealed class @samp : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.@samp);
	...
	public @samp this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@samp>> actions = new();
