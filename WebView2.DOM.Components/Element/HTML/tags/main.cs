...
public sealed class @main : HTMLElementBuilder, IEnumerable
{
	protected override HTMLElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.main);
	...
	public @main this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@main>> actions = new();
