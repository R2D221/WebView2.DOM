...
public sealed class @del : HTMLModElementBuilder, IEnumerable
{
	protected override HTMLModElement CreateElement() =>
		document.createHTMLElement(HTMLElementTag.del);
	...
	public @del this[ChildNodes childNodes]
	{
		get
		{
	...
	{
		internal readonly List<Action<@del>> actions = new();
